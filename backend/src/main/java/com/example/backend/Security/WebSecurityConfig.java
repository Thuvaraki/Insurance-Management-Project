    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer :: disable) //Disables CSRF  protection
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .permitAll().requestMatchers("/api/claims/retrieve_claims/status/**","/api/claims/manage_claimss/**","/api/policy/create","/api/policy/delete/**","/api/policy/update/**","/retrieve_claims/policy/**").hasRole("ADMIN")
